...
<body>
   ...
   <!-----------------------------------Page 1 Content------------------------------------------------>
                ...
                <a href="#page2" class="ui-btn" data-transition="slide" data-icon="home" data-ajax="false" >Products</a>
                <a href="#page3" class="ui-btn" data-transition="slide" data-icon="home">Current Orders</a>
                <a href="#page4" class="ui-btn" data-transition="slide" data-icon="home">Account Details</a>
                     ...
                     echo "<div data-role='collapsible'>
                            <h3>ID:".$o_id." ".$t."</h3>
                                <center><p class='collapsible_cont'>Your Order ID: ".$o_id."</p><br>
                                        ...
                                        <p class='collapsible_cont'>&euro;".$ttl."</p><br>
...
if($_POST){
    ...
    <!------------------------------------PAGE 5------------------------------------->
    <div id="page5" data-role="page" data-theme="b">
       <div data-role="header" data-position="fixed"><h1>Your Cart</h1></div>
        <div data-role="navbar" data-iconpos="bottom">
            <ul>
             <li><a href="#page2" data-icon="arrow-l"></a></li>
            </ul>
          </div>
<!--------------------------------------------------------------------------------------------->
...
<!--------------------------------------------------------------------------------------------->        
        <div data-role="footer" data-position="fixed"><h1><?php echo 'This is your Cart '.$_SESSION['username']; ?></h1></div>
    </div>                
